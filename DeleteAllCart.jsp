...
<html>
<head>
    <title>주문 완료 장바구니내용 삭제 or </title>
</head>
<body>
    <center>
        <%
        try {
            ...
            // 외래키 추가: Cart 테이블과 CartItem 테이블 간의 관계
            String jsql = "DELETE cart, cartItem FROM cart LEFT JOIN cartItem ON cart.cartId = cartItem.cartId WHERE cart.ctNo=?";
