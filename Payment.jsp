	...
	<main class="PayMain">
		...
		<section>
			...
			<article class="shopList">
				<table>
					...
					<tr class="cartCont">
						<th><input type="radio" name="payment" checked>카드</th>
						<th><input type="radio" name="payment">무통장 입금</th>
						<th><input type="radio" name="payment">카카오</th>
						<th><input type="radio" name="payment">네이버</th>
					</tr>
				</table>
			</article>
		</section>
		...
		<aside class="shopAside">
			<table>
				...
				<tr style="border-top: 2px solid #41926E;">
					<th>결제 수단</th>
					<td>카드</td>
				</tr>
			</table>
